...
train_dataframe = property_dataframe.sample(frac=0.95)
...
feature_columns = [bathroom, school_rating, bedroom, property_type, avg, size_buckets]
...
sample = pandas.DataFrame({'bathroom': 2, 'school_rating': 5, 'bedroom': 2, 'property_type': 'Condo', 'avg': 1200, 'size': 1000, 'list_price':0}, index=[0])
